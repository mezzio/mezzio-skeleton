...
class ProcessAnswersTest extends OptionalPackagesTestCase
{
    ...
    public function testAnsweredWithValidOption()
    {
        ...
        $this->io->write(Argument::containingString('Copying <info>config/MezzioAuraConfig.php</info>'))->shouldBeCalled();
        $this->io->write(Argument::containingString('Copying <info>config/MezzioAuraDelegatorFactory.php</info>'))->shouldBeCalled();
