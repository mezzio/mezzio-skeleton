...
- [zendframework/zend-expressive-skeleton#241](https://github.com/zendframework/zend-expressive-skeleton/pull/241)
  updates to mezzio 3.0.0rc5 and, by extension, laminas-expresive-router
  3.0.0rc5.

  This requires one change to the `config/pipeline.php` file: instead of piping
  `Mezzio\Router\Middleware\PathBasedRoutingMiddleware`, it now pipes
  `Mezzio\Router\Middleware\RouteMiddleware`. This is necessary as the
...
- This release updates the minimum supported version of mezzio to
  3.0.0rc4.
...
- [zendframework/zend-expressive-skeleton#235](https://github.com/zendframework/zend-expressive-skeleton/pull/235)
  updates to mezzio 3.0.0rc3 and mezzio-router 3.0.0rc4, as
...
- The skeleton now requires mezzio 3.0.0rc1. For detailed changes, see the
  [mezzio 3.0.0alpha6](https://github.com/mezzio/mezzio/releases/3.0.0alpha6),
  [mezzio 3.0.0alpha7](https://github.com/mezzio/mezzio/releases/3.0.0alpha7),
  [mezzio 3.0.0alpha8](https://github.com/mezzio/mezzio/releases/3.0.0alpha8),
  [mezzio 3.0.0alpha9](https://github.com/mezzio/mezzio/releases/3.0.0alpha9),
  and [mezzio 3.0.0rc1](https://github.com/mezzio/mezzio/releases/3.0.0rc1)
  changelogs.
...
- [zendframework/zend-expressive-skeleton#221](https://github.com/zendframework/zend-expressive-skeleton/pull/221)
  adds missing array return type to the shipped `ConfigProvider` classes.

- [zendframework/zend-expressive-skeleton#224](https://github.com/zendframework/zend-expressive-skeleton/pull/224)
  fixes unwanted removal of whitelisted packages.

- [zendframework/zend-expressive-skeleton#232](https://github.com/zendframework/zend-expressive-skeleton/pull/232)
...
- [zendframework/zend-expressive-skeleton#217](https://github.com/zendframework/zend-expressive-skeleton/pull/217)
