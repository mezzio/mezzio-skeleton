...
class OptionalPackages
{
    ...
    {
        $io->write("<info>Removing Mezzio installer classes, configuration, tests and docs</info>");
        ...
        // Remove MezzioInstaller exclusion from phpunit config
        $phpunitConfigFile = $projectRoot . '/phpunit.xml.dist';
        $phpunitConfig     = file_get_contents($phpunitConfigFile);
        $phpunitConfig     = self::removeLinesContainingStrings(['exclude', 'MezzioInstaller'], $phpunitConfig);
