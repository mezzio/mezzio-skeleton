...
return [
    'packages' => [
        ...
        'mezzio/mezzio-aurarouter'       => '^0.2',
        'mezzio/mezzio-fastroute'        => '^0.2',
        'mezzio/mezzio-platesrenderer'   => '^0.2',
        'mezzio/mezzio-twigrenderer'     => '^0.2',
        'mezzio/mezzio-laminasrouter'       => '^0.2',
        'mezzio/mezzio-laminasviewrenderer' => '^0.2',
